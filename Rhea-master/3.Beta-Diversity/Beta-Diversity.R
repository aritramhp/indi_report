...
setwd("/Users/aritra/Aritra/Dirk_Group/Patient_Report/Rhea-master/3.Beta-Diversity/")  #<--- CHANGE ACCORDINGLY !!!
...
input_tree = "ZOTUs-Tree-nj.tre"                   #<--- CHANGE ACCORDINGLY !!!
...
group_name = "Type"                            #<--- CHANGE ACCORDINGLY !!!
